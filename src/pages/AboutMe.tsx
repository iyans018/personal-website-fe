...
const AboutMe = () => {
    ...
    return (
        <>
            <section id="about" className="bg-dark min-h-screen flex flex-col items-center px-10 md:flex-row md:justify-between md:px-20">
                <img 
                ...
                <div className="flex flex-col gap-3 mt-4 md:gap-5 md:mt-0 md:w-3/5">
                    ...
                    <div className="flex flex-row gap-7 justify-center md:justify-start">
